...
public class ConnectionController {
    ...
    public ConnectionController(Connection connection, ConnectionStatus connectionStatus, ViewsController viewsController){
        ...
        connection.getChangeConnectionInfoPanel().getPortInfoLabel().setText("Port: "+ connectionStatus.getPort());

        connection.getChangeConnectionInfoPanel().getChangePortButton().addActionListener(e -> {
        ...
        connection.getChangeConnectionInfoPanel().getChangeIPButton().addActionListener(e -> {
